export const technologiesCopy = [
  {
    ...
    description:
      "Base sólida em HTML, CSS e JavaScript, permitindo construir sites bem estruturados, responsivos, interativos e de código limpo.",
  },
  {
    key: 2,
    title: "React & Next.JS",
    description:
      "Com React e Next.js, crio experiências fluidas e de alta performance. Gosto de trabalhar com componentes reutilizáveis e otimizações que tornam o site rápido e intuitivo em qualquer dispositivo.",
  },
  {
    key: 3,
